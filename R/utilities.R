...
review_hotspots = function(annotated_maf,
  ...
  if (length(intersect(supported_genes,
                       genes_of_interest)) == 0){
  ...
  if (length(setdiff(genes_of_interest, supported_genes)) > 0){
      message(strwrap(paste0("Currently only ", 
                             paste(supported_genes, collapse = ", "), 
                             " are supported. By default only these genes from the supplied list will be reviewed.
                             Reviewing hotspots for genes ", 
                             paste(intersect(supported_genes, genes_of_interest), collapse=", "),
...
get_gambl_colours = function(classification = "all",
  ...
  all_colours[["mutation"]] = c("Nonsense_Mutation" = unname(blood_cols["Red"]),
  ...
  all_colours[["pos_neg"]] = c("POS" = "#c41230",
                               "NEG" = "#E88873",
                               "PARTIAL" = "#E88873",
                               "yes" = "#c41230",
                               "no" = "#E88873",
  ...
  all_colours[["copy_number"]] = c("nLOH" = "#E026D7",
                                   "14" = "#380015",
                                   "15" = "#380015",
                                   "13" = "#380015",
                                   "12" = "#380015",
  ...
  all_colours[["blood"]] = c("Red" = "#c41230", "Blue" = "#115284", "Green" = "#39b54b",
                             "Purple" = "#5c266c", "Orange" = "#fe9003", "Green" = "#046852",
                             "Lavendar" = "#8781bd", "Steel Blue" = "#455564", "Light Blue" = "#2cace3",
                             "Magenta" = "#e90c8b", "Mustard" = "#b76d29", "LimeGreen" = "#a4bb87",
                             "Brown" = "#5f3a17", "Gray" = "#bdbdc1", "Yellow" = "#f9bd1f")
  
  all_colours[["sex"]]=c("M" = "#118AB2",
                         "Male" = "#118AB2",
                         "male" = "#118AB2",
                         "F" = "#EF476F",
                         "Female" = "#EF476F",
  ...
  all_colours[["pathology"]] = c("B-ALL" = "#C1C64B",
                                 "CLL" = "#889BE5",
                                 "MCL" = "#F37A20",
                                 "BL" = "#926CAD",
                                 "mBL" = "#34C7F4",
