---
title: "Utilities Tutorial - GAMBLR"
...
```{r remote, include = FALSE, warning = FALSE, message = FALSE}
...
#print head of returned FL genes
head(fl_genes_df, 5)
```
...
#print first 5 rows of chr1_q genes
head(chr1q_genes, 5)
```
...
#print first 5 rows of the returned data frame
head(chr8q_bins, 5)
```
...
```{r sv_to_bedpe_file, message = FALSE, warning = FALSE}
#get some SVs
