...
#create maf object
maf_obj2 = read.maf(maf_data, clinicalData = some_meta) 
...
just_metadata$pathology = as.factor(just_metadata$pathology)

#define order of factors for selected metadata column
just_metadata$pathology = factor(just_metadata$pathology, levels = c("DLBCL", "BL", "B-ALL", "CLL", "COMFL", "DLBCL-BL-like", "FL", "HGBL", "MCL", "PBL", "SCBC", "UNSPECIFIED"))
just_metadata = with(just_metadata, just_metadata[order(pathology),])
